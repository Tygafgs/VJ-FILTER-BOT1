...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6068324833').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002223719265').split()]  # For Multiple Id Use One Space Between Each.
...
SHORTLINK_API = environ.get('SHORTLINK_API', '90f5013aee678910531ae8b02d999c929e66aa99')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howtodownlodee') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
