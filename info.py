...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002406799151'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002254766492') # give your force subscribe channel id here else leave it blank
